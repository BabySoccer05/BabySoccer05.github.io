...
<body class="hold-transition login-page" style="background-color :cadetblue;">
  ...
  <div class="login-box" style="min-width: 35% !important; border-style: solid;">
    ...
    <div class="card" >
      <div class="card-body login-card-body" style="border-radius: 10px;">
        ...
        <hr>
        <p class="login-box-msg">Insert Your username and password</p>
        ...
        <p class="mb-1 text-center">
          <a href="<?php echo base_url('login/lupa') ?>">Forgot Password?</a> | <a href="<?php echo base_url() ?>" class="text-center">Home</a>
        </p>
      </div>
