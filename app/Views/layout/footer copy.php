...
<footer id="footer">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="footer-info">
            ...
            <div class="social-links mt-3">
              <a href="<?php echo $site['twitter'] ?>" target="_blank" class="twitter"><i class="fab fa-twitter"></i></a>
              <a href="<?php echo $site['facebook'] ?>" target="_blank" class="facebook"><i class="fab fa-facebook"></i></a>
              <a href="<?php echo $site['instagram'] ?>" target="_blank" class="instagram"><i class="fab fa-instagram"></i></a>
              <a href="<?php echo $site['youtube'] ?>" target="_blank" class="google-plus"><i class="fab fa-youtube"></i></a>
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          ...
          <ul>
            <?php foreach ($menu_profil as $menu_profil) { ?>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url('news/profil/' . $menu_profil['slug_berita']) ?>"><?php echo $menu_profil['judul_berita'] ?></a></li>
            <?php } ?>
        ...
        <!-- <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            <?php foreach ($menu_layanan as $menu_layanan) { ?>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url('news/layanan/' . $menu_layanan['slug_berita']) ?>"><?php echo $menu_layanan['judul_berita'] ?></a></li>
            <?php } ?>
          </ul>
        </div> -->
  ...
  <div class="container">
    <div class="copyright">
      &copy; Copyright <strong><span>Angel Group Indonesia</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
