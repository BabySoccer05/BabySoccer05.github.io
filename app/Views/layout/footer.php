...
<footer id="footer">
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          ...
          <ul>
            <?php foreach ($menu_profil as $menu_profil) { ?>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url('profile/' . $menu_profil['slug_berita']) ?>"><?php echo $menu_profil['judul_berita'] ?></a></li>
            <?php } ?>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url('contact') ?>">Staff &amp; Our team</a></li>
          </ul>
        </div>

        <!-- this is Footer Layanan -->
  ...
  <div class="container">
    <div class="copyright">
      &copy; Copyright <strong><span>Angel Grup Indonesia</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
